...
Begin VB.Form frmNFe 
   ...
   Caption         =   "Notas Fiscais Eletrônicas - NFe"
   ClientHeight    =   8595
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   9615
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmNFe.frx":030A
            Key             =   "Alterar"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmNFe.frx":0466
            Key             =   "Anterior"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmNFe.frx":05C2
            Key             =   "Cancelar"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmNFe.frx":071E
            Key             =   "Gravar"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmNFe.frx":0882
            Key             =   "Imprimir"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmNFe.frx":0E1E
            Key             =   "Excluir"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmNFe.frx":13BA
            Key             =   "Localizar"
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmNFe.frx":1516
            Key             =   "Novo"
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmNFe.frx":1672
            Key             =   "Inicio"
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmNFe.frx":17CE
            Key             =   "Proximo"
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmNFe.frx":192A
            Key             =   "Fim"
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmNFe.frx":1A86
            Key             =   "Outros"
         EndProperty
      EndProperty
   End
   Begin TabDlg.SSTab SSTab1 
      ...
      Begin VB.Frame fraTransportadorVolumes 
         ...
         Begin VB.ComboBox cmbUFPlaca 
            Height          =   315
            ItemData        =   "frmNFe.frx":2744
            Left            =   7920
            List            =   "frmNFe.frx":2746
         ...
         Begin VB.ComboBox cmbFreteConta 
            Height          =   315
            ItemData        =   "frmNFe.frx":2748
            Left            =   5400
            List            =   "frmNFe.frx":2758
            Style           =   2  'Dropdown List
            TabIndex        =   69
            Top             =   240
            Width           =   1935
         ...
         Begin VB.ComboBox cmbTransportador 
            Height          =   315
            ItemData        =   "frmNFe.frx":2796
            Left            =   1020
            List            =   "frmNFe.frx":2798
            Style           =   2  'Dropdown List
            TabIndex        =   67
            Top             =   240
            Width           =   3735
      ...
      Begin VB.Frame fraCabecalho 
         ...
         Begin VB.ComboBox cmbFormaPagamento 
            Height          =   315
            ItemData        =   "frmNFe.frx":279A
            Left            =   4380
            List            =   "frmNFe.frx":279C
            Style           =   2  'Dropdown List
            TabIndex        =   16
            Top             =   480
            Width           =   2505
         ...
         Begin VB.ComboBox cmbNaturezaOperacao 
            Height          =   315
            ItemData        =   "frmNFe.frx":279E
            Left            =   4380
            List            =   "frmNFe.frx":27A0
            Style           =   2  'Dropdown List
            TabIndex        =   11
            Top             =   165
            Width           =   2505
...
''      intItensNota = LerArquivoINI("Notas Fiscais", "ItensNota", CaminhoINI & "\Notas.ini")
''   Else
''      intItensNota = LerArquivoINI("Notas Fiscais", "ItensNota", CaminhoINI & "\NotasManuais.ini")
''   End If
''
''   Carrega_Combos
...
''         frmNFePesquisa.Show vbModal
''         rsNFe.MoveFirst
''         If Registro_Selecionado Then
''            rsNFe.Find "idNFe = " & Val(Mid(frmNFePesquisa.lvwDados.SelectedItem.Key, 2, Len(frmNFePesquisa.lvwDados.SelectedItem.Key)))
''         Else
''            rsNFe.Find "idNFe = " & RegistroAtual
''         End If
''         Prencher_Campos
...
''   If Not IsDate(mskDataEmissao.text) Or Val(Mid(mskDataEmissao.text, 7, 4)) < 1900 Then strMensagem = strMensagem & "Emissão" & Chr(13)
...
''   If cmbNaturezaOperacao.ListIndex = -1 Then strMensagem = strMensagem & "Natureza da Operação" & Chr(13)
...
''   If rsCFOPs.BOF Or rsCFOPs.EOF Then strMensagem = strMensagem & "CFOP não Encontrado" & Chr(13)
''
''   Set rsTemp = cnSistema.Execute("Select * From NFeInutilizadas Where Numero = " & mskNumero.text)
''   If Not rsTemp.EOF Then strMensagem = strMensagem & "Número de Nota Fiscal Inutilizada" & Chr(13)
''
''   ' Verifica Numeros
''   If Status = 1 Then
...
''         strMensagem = strMensagem & "Número da nota fora da sequência" & Chr(13)
''      End If
''   ElseIf Status = 2 Then
''      If mskNumero.text <> NotaAtual Then
''         strMensagem = strMensagem & "Número da nota não pode ser alterado" & Chr(13)
''      End If
''   End If
''
''
...
''      If MsgBox("Alterar Desconto dos Produtos", vbYesNo + vbQuestion, "Alteração") = vbYes Then
