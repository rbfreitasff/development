...
Private Sub Form_Load()
   ...
   ElseIf sEvento = "IN" Then
      ...
      txtInformacoes.Text = "Um número não de nota fiscal não pode ser Inutilizado caso a nota á tenha sido Aprovada, Cancelada ou Denegada."
...
Dim strMensagem As String
   ...
   If MsgBox("Confirma encerramento do Manifesto Nº " & txtNota.Text, vbYesNo + vbQuestion, "Confirmação") = vbYes Then
