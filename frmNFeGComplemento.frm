...
Begin VB.Form frmNFeGComplemento 
   ...
   Begin VB.Frame fraComplementos 
      ...
      Begin VB.ComboBox cmbSituacaoTributaria 
         Height          =   315
         ItemData        =   "frmNFeGComplemento.frx":0000
         Left            =   1260
         List            =   "frmNFeGComplemento.frx":0002
      ...
      Begin VB.ComboBox cmbUnidade 
         Height          =   315
         ItemData        =   "frmNFeGComplemento.frx":0004
         Left            =   1260
         List            =   "frmNFeGComplemento.frx":0006
         Style           =   2  'Dropdown List
         TabIndex        =   14
         Top             =   1500
         Width           =   1575
   ...
   End
End
Attribute VB_Name = "frmNFeGComplemento"
