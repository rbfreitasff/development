...
'   rsMDFe.Open "Select * from MDFe Order By Numero", cnSistema, adOpenForwardOnly, adLockOptimistic, 1
   ...
   lvwLocalCarregamento.ColumnHeaders.Add , , "Município", 4000
   ...
   lvwNFes.ColumnHeaders.Add , , "Número", 1000
...
'  UFs
   ...
   ' Tipo de Emitente
   cboTipoEmitente.AddItem "1. Prestador de serviço de transporte"
   cboTipoEmitente.ItemData(cboTipoEmitente.NewIndex) = 1

   cboTipoEmitente.AddItem "2. Não prestador de serviço de transporte"
   cboTipoEmitente.ItemData(cboTipoEmitente.NewIndex) = 2

   cboTipoEmitente.AddItem "3. Prestador de serviço de transporte que emitirá CT-e Globalizado"
   ...
   cboTipoRodado.AddItem "03. Cavalo Mecânico"
   ...
   cboTipoRodado.AddItem "05. Utilitário"
   ...
   ' Tipo de Carroceria
   cboTipoCarroceria.AddItem "00. Não aplicável"
   ...
   cboTipoCarroceria.AddItem "02. Fechada/Baú"
...
Verifica_Campos_NFes = True
   ...
   If txtNumeroNota.Text = Empty Then strMensagem = strMensagem & "Número" & Chr(13)
   If txtChaveNFe.Text = Empty Then strMensagem = strMensagem & "Chave da NFe" & Chr(13)
   If Len(txtChaveNFe.Text) <> 44 Then strMensagem = strMensagem & "Tamanho da Chave está incorreto" & Chr(13)
